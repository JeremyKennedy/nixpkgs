...
let
  ...
  pythonDeps = with python.pkgs; [
    flask flask_assets flask_login flask_sqlalchemy flask_migrate flask-seasurf flask_mail flask-sslify flask-session
...
in stdenv.mkDerivation rec {
  ...
  passthru = {
    ...
    tests = { inherit (nixosTests) powerdns-admin; };
  };
