{ stdenv, lib, fetchFromGitLab, fetchurl, fetchpatch, buildPackages
...
self = stdenv.mkDerivation {
  ...
  # We can't change the length of the path
  # unstable-2021-07-26
  version = "21.3.0";
  ...
  src = fetchFromGitLab {
    ...
    owner = "mesa";
    repo = "mesa";
    rev = "53c39f710ffa86fbc1107002b818cb5ed8ddd1f0";
    sha256 = "1hk6w6yak6s75s9bhys76q7ca1vxk1lcsyxabi7q5lsdd5pbj4aq";
  };
